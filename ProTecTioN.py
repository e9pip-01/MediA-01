...
def get_red_btn():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="اشترك بالقناة", url=channel_button_url)]
    ])
...
async def add_command_old(message: Message, state: FSMContext, bot: Bot):
    ...
    all_base_cmds = {
        ...
        "تنزيل الكل", "تك", "كتم", "طرد", "نبذ", "تقييد", "تق", "مسح المكتومين", "؟", "مسح المنبوذين", "/", "مسح المقيدين", "-", "اضف امر", "مسح امر"
    }
