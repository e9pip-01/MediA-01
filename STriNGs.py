...
async def handle_response_1(message: types.Message, animate_func):
    ...
    inline_kb = types.InlineKeyboardMarkup(inline_keyboard=get_attached_buttons())
    await animate_func(message, text, reply_markup=inline_kb)
